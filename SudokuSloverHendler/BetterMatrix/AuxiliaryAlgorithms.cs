...
namespace SudokuSloverHendler.BetterMatrix
{
    public partial class BetterMatrix : Matrix<Point>
    {
        ...
        public Set<int> GetPossValueInPosPoint(PosPoint pos_p)
        { return new Set<int>(this.matrix[pos_p.i, pos_p.j].set); }
        public bool IsNullInPosPoint(PosPoint pos_p)
        { return this.matrix[pos_p.i, pos_p.j].value == 0; }
        public bool IsPossibleValueInPos(PosPoint pos_p, int value)
        ...
        private Arrange<PosPoint> GetPossPosPointsInRange(PosPoint pos1, PosPoint pos2, int value)
        {
        ...
        public Arrange<PosPoint> GetPossPosPointsInHorizontalLine(int index, int value)
        { return this.GetPossPosPointsInRange(new PosPoint(index, 0), new PosPoint(index, size - 1), value); }
        public Arrange<PosPoint> GetPossPosPointsInVerticalLine(int index, int value)
        { return this.GetPossPosPointsInRange(new PosPoint(0, index), new PosPoint(size - 1, index), value); }
        public Arrange<PosPoint> GetPossPosPointsInSquare(PosSquare pos_s, int value)
        { return this.GetPossPosPointsInRange(new PosPoint(pos_s.i * 3, pos_s.j * 3), new PosPoint(pos_s.i * 3 + 2, pos_s.j * 3 + 2), value); }

        private int GetCountPossiblePosPointInRange(PosPoint pos1, PosPoint pos2, int value)
        {
            int count = 0;
            for (int i = pos1.i; i <= pos2.i; i++)
            {
        ...
        public int GetCountPossiblePosPointInHorizontalLine(int index, int value)
        { return this.GetCountPossiblePosPointInRange(new PosPoint(index, 0), new PosPoint(index, size - 1), value); }
        public int GetCountPossiblePosPointInVerticalLine(int index, int value)
        { return this.GetCountPossiblePosPointInRange(new PosPoint(0, index), new PosPoint(size - 1, index), value); }
        public int GetCountPossiblePosPointInSquare(PosSquare pos_s, int value)
        ...
        private PosPoint GetFirstPossiblePosPointInRange(PosPoint pos1, PosPoint pos2, int value)
        {
            for (int i = pos1.i; i <= pos2.i; i++)
            {
                for (int j = pos1.j; j <= pos2.j; j++)
        ...
        public PosPoint GetFirstPossiblePosPointInHorizontalLine(int index, int value)
        { return this.GetFirstPossiblePosPointInRange(new PosPoint(index, 0), new PosPoint(index, size - 1), value); }
        public PosPoint GetFirstPossiblePosPointInVerticalLine(int index, int value)
        { return this.GetFirstPossiblePosPointInRange(new PosPoint(0, index), new PosPoint(size - 1, index), value); }
        public PosPoint GetFirstPossiblePosPointInSquare(PosSquare pos_s, int value)
